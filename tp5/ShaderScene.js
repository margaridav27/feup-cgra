...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/tp5.2.vert", "shaders/tp5.2.frag"),
			new CGFshader(this.gl, "shaders/tp5.3.vert", "shaders/tp5.3.frag"),
		...
		this.shadersList = {
			...
			'Sepia': 7,
			'Convolution': 8,
			'TP5.1 Blue & Yellow Shader' : 9,
			'TP5.2 Moving Shader' : 10,
			'TP5.3 Grayscale Shader' : 11,
			'TP5.4 Water shader': 12
		};
